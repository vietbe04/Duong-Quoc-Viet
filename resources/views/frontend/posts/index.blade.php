                ...
                <div class="row g-0">
                    <div class="col-md-4">
                        <a href="{{ route('posts.show', $post->slug) }}">
                            <img src="/storage/{{ $post->image }}" class="img-fluid rounded-start h-100" alt="{{ $post->name }}" style="object-fit: cover;">
                        </a>
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
        ...
        <div class="col-lg-4">
            ...
            <div class="sidebar-widget">
                ...
                <div class="d-flex mb-3">
                    <img src="/storage/{{ $recent->image }}" alt="" width="80" height="60" class="me-3" style="object-fit: cover; border-radius: 5px;">
                    <div>
                        <h6 class="mb-1">
