    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <article>
                ...
                @if($post->image)
                <img src="/storage/{{ $post->image }}" class="img-fluid rounded mb-4 w-100" alt="{{ $post->name }}" style="max-height: 500px; object-fit: cover;">
                @endif
                ...
                <!-- Gallery Ảnh (Top IT Feature) -->
                @if($post->images && count($post->images) > 0)
                <div class="post-gallery mb-5">
                    <h4 class="mb-4"><i class="fas fa-images me-2"></i> Album hình ảnh</h4>
                    <div class="row g-3">
                        @foreach($post->images as $img)
                        <div class="col-md-4 col-6">
                            <a href="/storage/{{ $img }}" target="_blank">
                                <img src="/storage/{{ $img }}" class="img-fluid rounded shadow-sm gallery-item" alt="Gallery image">
                            </a>
                        </div>
                        @endforeach
                    </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="sidebar-widget">
                ...
                <div class="d-flex mb-3">
                    <img src="/storage/{{ $related->image }}" alt="" width="80" height="60" class="me-3" style="object-fit: cover; border-radius: 5px;">
                    <div>
                        <h6 class="mb-1">
